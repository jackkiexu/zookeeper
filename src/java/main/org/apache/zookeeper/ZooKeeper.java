...
public class ZooKeeper {
    ...
    /**
     * ��ȡ client ���� server �Ŀͻ���, ������ ClientCnxnSocket
     * (����ʹ�� netty ��Ϊ�ײ��������, �� �� java �����м��� -Dzookeeper.serverCnxnFactory=org.apache.zookeeper.server.NIOServerCnxnFactory)
     *
     */
